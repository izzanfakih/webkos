...
.wrapperAlert {
  ...
  box-shadow: -7.552px 9.326px 25px 0px rgba(1, 84, 85, 0.1);        
}
    ...
    <div class="wrapperAlert">
        <div class="contentAlert">
          ...
          <div class="bottomHalf">   
            <p>Selamat ya atas pemesanannya, semoga kamu suka sama tempatnya...</p> 
            <a href="{{ route('kosan') }}"><button id="alertMO">Kembali</button></a>
          </div>
        </div>        
      </div>
</body>
